...
class tShipperAccount
{
	...
	const COLUMN_TYPES = [
		'kShipperAccount' => 'int',
		'kShipperAccountParent' => 'int',
		'cDisplayName' => 'varchar',
		'cUserName' => 'varchar',
		'cPassword' => 'varchar',
		'nVersanddienstleister' => 'tinyint',
		'nAddressSourceType' => 'tinyint',
		'kFirma' => 'int',
		'cSalutation' => 'varchar',
		'cTitle' => 'varchar',
		'cCompany' => 'varchar',
		...
		'cCity' => 'varchar',
		'cBankName' => 'varchar',
		'cBankAccountOwner' => 'varchar',
		'cIban' => 'varchar',
		'cBic' => 'varchar',
		'cEkp' => 'varchar',
		'cInternationalEkp' => 'varchar',
		'cShipperNumber' => 'varchar',
		'cAccessLicenceNumber' => 'varchar',
		'cPhone' => 'varchar',
		'nAccountType' => 'tinyint',
		'nTestAccount' => 'tinyint',
		'fCodFee' => 'decimal',
		'cRetourenEkp' => 'varchar',
		'cGlsCustomerId' => 'varchar',
		'cGlsContactId' => 'varchar',
	];
