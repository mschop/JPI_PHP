...
class ebay_item
{
	...
	const COLUMN_TYPES = [
		...
		'ApplyShippingDiscount' => 'tinyint',
		'AutoPay' => 'tinyint',
		'BestOfferEnabled' => 'tinyint',
		'BusinessSeller' => 'tinyint',
		'BuyItNowPrice' => 'decimal',
		'BuyerProtection' => 'varchar',
		'CategoryBasedAttributesPrefill' => 'tinyint',
		'CategoryMappingAllowed' => 'tinyint',
		'ChangePaymentInstructions' => 'tinyint',
		'Country' => 'varchar',
		'Currency' => 'varchar',
		'DispatchTimeMax' => 'tinyint',
		'GalleryType' => 'varchar',
		'GalleryURL' => 'varchar',
		'GetItFast' => 'tinyint',
		'GiftIcon' => 'tinyint',
		'GiftServices' => 'varchar',
		'HitCount' => 'int',
		'HitCounter' => 'varchar',
		'ItemID' => 'varchar',
		'LinkedPayPalAccount' => 'tinyint',
		'ListingDuration' => 'varchar',
		'ListingEnhancement' => 'varchar',
		'ListingType' => 'varchar',
		'Location' => 'varchar',
		'LotSize' => 'int',
		'NowAndNew' => 'tinyint',
		'PayPalEmailAddress' => 'varchar',
		'PaymentMethods' => 'varchar',
		'PhotoDisplay' => 'varchar',
		'PictureURL' => 'varchar',
		'PostalCode' => 'varchar',
		'PrimaryCategoryId' => 'int',
		'PrivateListing' => 'tinyint',
		'Quantity' => 'int',
		'QuestionCount' => 'int',
		'ReservePrice' => 'decimal',
		'RestrictedToBusiness' => 'tinyint',
		'SKU' => 'varchar',
		'SS_BidderCount' => 'int',
		...
		'ShipToLocations' => 'varchar',
		'ShippingTerms' => 'varchar',
		'ShippingTermsInDescription' => 'tinyint',
		...
		'SubTitle' => 'varchar',
		'ThirdPartyCheckout' => 'tinyint',
		'Title' => 'varchar',
		'UUID' => 'varchar',
		'VATPercent' => 'decimal',
		'WatchCount' => 'int',
		'Type' => 'char',
		'ScheduleServerSide' => 'char',
		'kArtikel' => 'int',
		'kEbayuser' => 'int',
		'htmlTemplate' => 'int',
		'Sent' => 'char',
		...
		'kPlanung' => 'int',
		'kPlanungsItem' => 'int',
		'cRelistedItemID' => 'varchar',
		'fGewicht' => 'decimal',
		'kKategorie' => 'int',
		'BestOfferMinPrice' => 'decimal',
		'kTemplate' => 'int',
		'nVKSonderregel' => 'tinyint',
		'DiscountProfileID' => 'varchar',
		'nPickup' => 'tinyint',
		'nPremium' => 'tinyint',
		'cRelistID' => 'varchar',
		'BestOfferAutoAcceptPrice' => 'decimal',
		'nVKSonderregelInt' => 'tinyint',
		'DiscountProfileIDInt' => 'varchar',
		'nVariationenAktiv' => 'tinyint',
		'kEigenschaft' => 'int',
		'nReturnPolicy' => 'tinyint',
		'ConditionID' => 'int',
		'nLaufend' => 'int',
		'MaxQuantity' => 'int',
		'nAutomatischEinstellen' => 'tinyint',
		'nSchwelleAutomatischEinstellen' => 'int',
		'nLeecher' => 'tinyint',
		'SiteID' => 'int',
		'cRueckgabeMoeglich' => 'varchar',
		'cRueckgabefrist' => 'varchar',
		'cVersandkostenTraeger' => 'varchar',
		'bBestandReserviert' => 'tinyint',
		'nUseHomeShippingCostTable' => 'tinyint',
		'nUseInternationalShippingCostTable' => 'tinyint',
		'dZuEbayGesendet' => 'datetime',
		'nFehler' => 'int',
		'kMessage' => 'bigint',
		'cEbayUserProfileIdShipping' => 'varchar',
		'cEbayUserProfileIdPayment' => 'varchar',
		'cEbayUserProfileIdReturn' => 'varchar',
		'ConditionDescription' => 'varchar',
		'fStreichPreis' => 'decimal',
		'cStreichPreisTyp' => 'varchar',
		'nEbayPlus' => 'tinyint',
		'nProduktKennzeichnung' => 'tinyint',
		'cEAN' => 'varchar',
		'nMinQuantity' => 'int',
		'nNurAnGewerbliche' => 'tinyint',
	];
