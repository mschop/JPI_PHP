...
class tArtikel
{
	...
	const COLUMN_TYPES = [
		...
		'cPreisliste' => 'char',
		'cAktiv' => 'char',
		'nLagerbestand' => 'decimal',
		'nMindestbestellmaenge' => 'decimal',
		'cBarcode' => 'varchar',
		...
		'nMidestbestand' => 'decimal',
		'fEKNetto' => 'decimal',
		'fEbayPreis' => 'decimal',
		'cLagerVariation' => 'char',
		'nDelete' => 'tinyint',
		'dMod' => 'datetime',
		'fPackeinheit' => 'decimal',
		'nVPE' => 'tinyint',
		'fVPEWert' => 'decimal',
		'cSuchbegriffe' => 'varchar',
		'cTaric' => 'varchar',
		'cHerkunftsland' => 'varchar',
		'kSteuerklasse' => 'int',
		...
		'nPufferTyp' => 'tinyint',
		'nPuffer' => 'int',
		'nProzentualePreisStaffelAktiv' => 'tinyint',
		'nSeriennummernVerfolgung' => 'tinyint',
		'kHersteller' => 'int',
		'kLieferStatus' => 'int',
		'kMassEinheit' => 'int',
		'fMassMenge' => 'decimal',
		'kGrundPreisEinheit' => 'int',
		'fGrundpreisMenge' => 'decimal',
		'fBreite' => 'decimal',
		'fHoehe' => 'decimal',
		'fLaenge' => 'decimal',
		'kVPEEinheit' => 'int',
		'nLiefertageWennAusverkauft' => 'int',
		'kVerkaufsEinheit' => 'int',
		'dZulaufVerfuegbarAm' => 'datetime',
		'nAutomatischeLiefertageberechnung' => 'tinyint',
		'nBearbeitungszeit' => 'int',
		'fLetzterEK' => 'decimal',
		'dLetzterEK' => 'datetime',
		'kBenutzerLetzteAenderung' => 'int',
		'nZulaufVerfuegbarMenge' => 'decimal',
		'dNeuImSortiment' => 'datetime',
		'nEbayAbgleich' => 'tinyint',
		'kZustand' => 'int',
		'cAmazonFNSKU' => 'varchar',
		'cJfpid' => 'varchar',
