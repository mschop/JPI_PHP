...
class tprintform
{
	...
	const COLUMN_TYPES = [
		...
		'fFDLinks' => 'decimal',
		'fFDOben' => 'decimal',
		'cFirmendatenklein' => 'char',
		'cFirmendatendrucken' => 'char',
		'cFuss' => 'varchar',
		'cKdNrDrucken' => 'char',
		'cbzglAuftragDrucken' => 'char',
		'cRechnungZzglMwst' => 'char',
		'fGLinks' => 'decimal',
		'fGRechts' => 'decimal',
		...
		'fFmitte' => 'decimal',
		'fFoben' => 'decimal',
		'cZahlungsziel' => 'varchar',
		'fFbreite' => 'decimal',
		'nZwischensumme' => 'tinyint',
		'cEinheit' => 'char',
		'cLieferText' => 'varchar',
		'nVariationAufpreis' => 'tinyint',
		'nLAdrDrucken' => 'tinyint',
		'nTelDrucken' => 'tinyint',
		'nPixelFont' => 'tinyint',
		'cIGLText' => 'varchar',
		'cUStFreiText' => 'varchar',
		'cReverseCharge' => 'varchar',
	];
