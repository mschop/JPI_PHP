...
class ebay_checkout
{
	...
	const COLUMN_TYPES = [
		...
		'cLieferAnrede' => 'varchar',
		'cLieferVorname' => 'varchar',
		'cLieferNachname' => 'varchar',
		'cLieferNamenszusatz' => 'varchar',
		'cLieferStrasse' => 'varchar',
		'cLieferAdresszusatz' => 'varchar',
		'cLieferPLZ' => 'varchar',
		'cLieferOrt' => 'varchar',
		'cLieferOrtszusatz' => 'varchar',
		'cLieferLand' => 'varchar',
		'cLieferTel' => 'varchar',
		'cLieferFax' => 'varchar',
		'cLieferHandy' => 'varchar',
		'cZahlungsart' => 'varchar',
		'cZahlungBankName' => 'varchar',
		'cZahlungBLZ' => 'varchar',
		'cZahlungKontoNr' => 'varchar',
		'cZahlungKartenNr' => 'varchar',
		'cZahlungGueltigkeit' => 'varchar',
		'cZahlungCVV' => 'varchar',
		'cZahlungKartenTyp' => 'varchar',
		'cZahlungInhaber' => 'varchar',
		'fVersandkosten' => 'decimal',
		'dErstelltAm' => 'datetime',
		'dAbgeschlossenAm' => 'datetime',
		'nStatus' => 'tinyint',
		'nAnzahlPos' => 'tinyint',
		'fSumme' => 'decimal',
		'cVersandArt' => 'varchar',
		...
		'cComment' => 'varchar',
		'cFirma' => 'varchar',
		'cLieferFirma' => 'varchar',
		'cUStID' => 'varchar',
		'cAdresszusatz' => 'varchar',
		'cAnrede' => 'varchar',
		'cVorname' => 'varchar',
		'cNachname' => 'varchar',
		'nCheckoutType' => 'tinyint',
		'cPaymentStatus' => 'varchar',
		'cPLZ' => 'varchar',
		'cOrt' => 'varchar',
		'cLand' => 'varchar',
		'nNeu' => 'int',
		'cStrasse' => 'varchar',
		'cPaypalTransactionID' => 'varchar',
