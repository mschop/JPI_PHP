...
class pf_user
{
	...
	const COLUMN_TYPES = [
		...
		'kBenutzer' => 'int',
		'nZahlung' => 'int',
		'cVersandName' => 'varchar',
		'nBenutzePosName' => 'int',
		'dInventardaten' => 'datetime',
		'dInventardatenFBA' => 'datetime',
		'nVersandpos0' => 'int',
		'nAnmerkung' => 'int',
		'cAnmerkung' => 'varchar',
		'nLagerSenden' => 'int',
		'nRepricing' => 'tinyint',
		'dRepricingFull' => 'datetime',
		'nEU' => 'tinyint',
		'nFBALagerAbziehen' => 'tinyint',
		'kVersandartStandard' => 'int',
		'kVersandartExpedited' => 'int',
		'nFBAVersandmailAnKunde' => 'tinyint',
		'cFBAVersandmailKopie' => 'varchar',
		'nIgnorierePaymentsBestellungen' => 'tinyint',
		'cFBAKommentar' => 'varchar',
		'kZahlungsart' => 'int',
		'cAmazonAuthToken' => 'varchar',
		'kVersandartNextDayNonPrime' => 'int',
		'kVersandartSecondDayNonPrime' => 'int',
		'kVersandartPrimeStandard' => 'int',
		'kKundengruppe' => 'int',
		'nBearbeitungszeitAnpassen' => 'tinyint',
		'nInventardatenAnfordern' => 'tinyint',
		'nBearbeitungszeitAufschlag' => 'tinyint',
		'dStartVCS' => 'datetime',
	];
